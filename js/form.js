...
btnEnviar.addEventListener('click', function(event){
    ...
    window.location.href = `mailto:yudaangely@gmail.com?subject=Envío%20Formulario%20Maquillaje&body=Nombre%3A%20${nombrePersona}%0ACorreo%3A%20${emailPersona}%0ANacimiento%3A%20${nacimientoPersona}%0AG%C3%A9nero%3A%20${generoPersona}%0ASalario%3A%20%E2%82%A1${rangoSalarioPersona}%0AEstudios%3A%20${gradoAcademicoPersona}`;
});
